package com.dome.pachong.infokafka.kafka;

import com.dome.pachong.infokafka.entity.UrlTask;
import com.dome.pachong.infokafka.util.GsonUtil;
...
public class TaskProducer {
    ...
    public void sendUrlTask(UrlTask task) {
        ...
        ListenableFuture<SendResult<String, String>> listenableFuture = kafkaTemplate.send(taskTopic, data);
        // 发送成功回调
